...
### python tfrecord.py data/csv/eval.csv data/label/label_map.pbtxt data data/tfrecord/tfrecord_eval.record
### python tfrecord.py data/csv/train.csv data/label/label_map.pbtxt data data/tfrecord/tfrecord_train.record
